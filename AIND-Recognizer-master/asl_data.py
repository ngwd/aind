...
if __name__ == '__main__':
    ...
    from my_recognizer import recognize, recognize_plus_slm
    from asl_utils import show_errors
    from my_model_selectors import SelectorCV
    
    models = train_all_words(features, SelectorCV)
    test_set = asl.build_test(features)

    probabilities, guesses = recognize_plus_slm(models, test_set)
